#!/usr/bin/env python3
"""Build the TCR-format R2M manuscript .docx from manuscript_tcr.md + figures + tables.

AME/Translational Cancer Research submission layout:
title page -> abstract+keywords -> highlight box -> main text -> acknowledgments ->
footnote -> references -> tables -> figures (with legends).
"""
import re
...
MD = Path('/workspace/r2m/manuscript_tcr.md')
OUT = Path('/workspace/r2m/R2M_manuscript_TCR.docx')
